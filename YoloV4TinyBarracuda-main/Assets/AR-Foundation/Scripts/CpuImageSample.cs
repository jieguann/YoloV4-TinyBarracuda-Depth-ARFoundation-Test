...
using UnityEngine.XR.ARSubsystems;
    ...
    public RawImage depthTextureRawImage;
    ...
    public ARCameraManager cameraManager
        ...
        m_CameraTexture = rotateTexture(m_CameraTexture);
        // Apply the updated texture data to our texture
        m_CameraTexture.Apply();
            

            cameraTexture = m_CameraTexture as Texture;
        ...
        void UpdateEnvironmentDepthImage()
        {
            ...
            if (occlusionManager && occlusionManager.TryAcquireEnvironmentDepthCpuImage(out var image))
            {
                ...
                depthTexture = UpdateRawImage(m_RawEnvironmentDepthImage, image, m_Transformation);
                depthTexture = rotateTexture(depthTexture);
                depthTextureRawImage.texture =depthTexture;
                }
            }
            else
            {
        ...
        Texture2D UpdateRawImage(RawImage rawImage, XRCpuImage cpuImage, XRCpuImage.Transformation transformation)
        {
